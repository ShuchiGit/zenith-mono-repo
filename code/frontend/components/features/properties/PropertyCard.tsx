...
export function PropertyCard({ property }: PropertyCardProps) {
  const image = property.coverImage || property.images?.[0] || PLACEHOLDER
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden bg-[#edf6f9]">
        ...
        <div className="absolute top-3 left-3 flex gap-2">
          ...
          <span className="bg-[#003338]/70 text-white text-xs font-semibold px-2.5 py-1 rounded-full">
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="mt-auto pt-4 border-t border-[#83c5be]/20 flex items-center justify-between">
          <div>
            ...
            <p className="font-heading text-[#006d77] font-semibold">{formatPrice(property.price)}</p>
          </div>
